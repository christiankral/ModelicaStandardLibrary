...
equation
  connect(core.port_n, measuringCoil.port_p)
    annotation (Line(points={{20,30},{30,30},{30,10}}, color={255,127,0}));
  connect(measuringCoil.port_n, airGap.port_p)
    annotation (Line(points={{30,-10},{30,-50},{20,-50}},
                                                 color={255,127,0}));
  connect(excitingCoil.port_n, magFluxSensor.port_n)
    annotation (Line(points={{-10,-10},{-10,-20}}, color={255,127,0}));
  connect(magFluxSensor.port_p, magneticGround.port)
    annotation (Line(points={{-10,-40},{-10,-50}}, color={255,127,0}));
  connect(magneticGround.port, airGap.port_n)
    annotation (Line(points={{-10,-50},{0,-50}},   color={255,127,0}));
  connect(excitingCoil.port_p, core.port_p)
    annotation (Line(points={{-10,10},{-10,30},{0,30}},   color={255,127,0}));
  connect(currentSource.pin_p,electricGround1. pin) annotation (Line(points={{-50,-10},{-40,-10}}, color={85,170,255}));
  connect(electricGround1.pin, excitingCoil.pin_n) annotation (Line(points={{-40,-10},{-30,-10}}, color={85,170,255}));
  connect(currentSource.pin_n, excitingCoil.pin_p) annotation (Line(points={{-50,10},{-30,10}}, color={85,170,255}));
  ...
  connect(voltageSensor.pin_p, measuringCoil.pin_p) annotation (Line(points={{70,10},{50,10}}, color={85,170,255}));
