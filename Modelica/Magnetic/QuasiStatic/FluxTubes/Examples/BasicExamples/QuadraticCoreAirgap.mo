...
parameter Integer N=500 "Number of turns of exciting coil";
  ...
  Modelica.Electrical.QuasiStatic.SinglePhase.Sources.VariableCurrentSource currentSource annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-60,0})));
  ...
  Modelica.Blocks.Sources.RealExpression usefulReluctance(y=1/airGap.G_m) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={30,-20})));
  Blocks.Sources.Constant const(k=10.6103)
